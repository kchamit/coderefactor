...
import com.ibm.cleancode.unf.visitors.TryBlockRemovingVisitor;

public class TryBlockRemovingInspector {
	...
	public static void main(String[] args) throws Exception {
		for (String project : RSAProjectHelper.getAllButBillingProjects()) {
			...
			TryBlockRemovingVisitor visitor = new TryBlockRemovingVisitor(true);
			...
			for (File sourceFile : sourceFiles) {
				...
				FileUtils.write(sourceFile, processor.start(sourceCode), "cp1252");
			}
